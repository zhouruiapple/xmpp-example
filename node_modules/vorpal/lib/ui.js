...
var ui = {
  ...
  _keypressHandler: function(e, prompt) {
    ...
    this.emit("vorpal_ui_keypress", { key: key, value: value });
  },
  ...
  pause: function() {
    ...
    var posX = this._activePrompt.rl._getCursorPos().cols;  
    rl.output.unmute();
    screen.clean();
    rl.output.write('');
    return val;
  ...
  log: function() {
    var args = VorpalUtil.fixArgsForApply(arguments);
    ...
    args = VorpalUtil.fixArgsForApply(args);
    if (this.midPrompt()) {
      var data = this.pause();
